        ...
        <header class="site__header d-lg-block d-none">
            <div class="site-header">
                ...
                <div class="site-header__nav-panel">
                    <!-- data-sticky-mode - one of [pullToShow, alwaysOnTop] -->
                    <div class="nav-panel nav-panel--sticky nav-panel--stuck" data-sticky-mode="pullToShow" style="">
                                    ...
                                    <div class="product-gallery__featured">
                                        ...
                                        <div class="owl-carousel owl-loaded owl-drag" id="product-image">
                                            ...
                                            <div class="owl-stage-outer">
                                                <div class="owl-stage" style="transform: translate3d(0px, 0px, 0px); transition: all 0.25s ease 0s; width: 2655px;">
                    ...
                    <div class="product-tabs product-tabs--sticky">
                        <div class="product-tabs__list">
                            <div class="product-tabs__list-body">
                                <div class="product-tabs__list-container container">
                                    ...
                                    <a href="#tab-specification" class="product-tabs__item product-tabs__item--active">Especificaciones</a>
                        ...
                        <div class="product-tabs__content">
                            ...
                            <div class="product-tabs__pane product-tabs__pane--active" id="tab-specification">
                                <div class="spec">
                                    <h3 class="spec__header">Especificación</h3>
                                    <div class="spec__section">
                                        <h4 class="spec__section-title">General</h4>
                                        <div class="spec__row">
                                            <div class="spec__name">Material</div>
                                            <div class="spec__value">Acero</div>
                                        </div>
                                        <div class="spec__row">
                                            <div class="spec__name">Color</div>
                                            <div class="spec__value">Plomo</div>
                                        </div>
                                        <div class="spec__row">
                                            <div class="spec__name">Tipo xxxxx</div>
                                            <div class="spec__value">XXXXX</div>
                                        </div>
                                        <div class="spec__row">
                                            <div class="spec__name">Tipo xxxx</div>
                                            <div class="spec__value">YYYYYYY</div>
                                        </div>
                                    ...
                                    <div class="spec__section">
                                        ...
                                        <div class="spec__row">
                                            <div class="spec__name">Tamaño</div>
                                            <div class="spec__value">XXX mm</div>
                                        </div>
                                        <div class="spec__row">
                                            <div class="spec__name">Ancho</div>
                                            <div class="spec__value">xxx mm</div>
                                        </div>
                                        <div class="spec__row">
                                            <div class="spec__name">Alto</div>
                                            <div class="spec__value">xxx mm</div>
                                        </div>
                                    </div>
                                    <div class="spec__disclaimer">
                                        La información sobre las características técnicas,
                                        el conjunto de entrega, el país de fabricación y la apariencia de
                                        los productos es solo de referencia y se basa en la información más
                                        reciente disponible en el momento de la publicación.
                                    </div>
                                </div>
                            </div>
                ...
                <div class="container">
                    ...
                    <div class="block-products-carousel__slider">
                        ...
                        <div class="owl-carousel owl-loaded owl-drag">
                            ...
                            <div class="owl-stage-outer">
                                <div class="owl-stage" style="transform: translate3d(-1120px, 0px, 0px); transition: all 0s ease 0s; width: 3362px; padding-left: 1px; padding-right: 1px;">
                                                    ...
                                                    <div class="product-card__badges-list">
                                                        <div class="product-card__badge product-card__badge--sale">
                                                            <font style="vertical-align: inherit;">
                                                                <font style="vertical-align: inherit;">Promoción</font>
                                                            </font>
                                                        </div>
                                                    </div>
                                                    <div class="product-card__image product-image">
                                                        <a href="product.html" class="product-image__body">
                                                            <img class="product-image__img" src="images\navajas\mediaO.png" alt="">
                                                        </a>
                                                    </div>
                                                    <div class="product-card__info">
                                                        <div class="product-card__name">
                                        ...
                                        <div class="block-products-carousel__column">
                                            <div class="block-products-carousel__cell">
                                                <div class="product-card product-card--hidden-actions">
                                                    ...
                                                    <div class="product-card__image product-image">
                                                        <a href="product.html" class="product-image__body">
                                                            <img class="product-image__img" src="images\navajas\tipoSeperak9Milimetros.png" alt="">
                                                        </a>
                                                    </div>
                                                    <div class="product-card__info">
                                                        <div class="product-card__name">
