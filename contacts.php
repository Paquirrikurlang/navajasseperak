                            ...
                            <div class="contact-us__container">
                                <div class="row">
                                    <div class="col-12 col-lg-6 pb-4 pb-lg-0">
                                        ...
                                        <div class="contact-us__address">
                                            ...
                                            <p><strong>Comentario</strong><br>
                                                ...
                                                para poder ayudarte, si deseas información de algún producto puedes comunicarte conmigo
                                    ...
                                    <div class="col-12 col-lg-6">
                                        ...
                                        <form>
                                            <div class="form-row">
                                                <div class="form-group col-md-6"><label for="form-name">Tu nombre</label> <input type="text" id="form-name" class="form-control" placeholder="Tu nombre"></div>
                                            ...
                                            <div class="form-group"><label for="form-subject">Tema</label> <input type="text" id="form-subject" class="form-control" placeholder="Tema"></div>
