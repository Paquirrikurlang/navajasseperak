(function($) {
  ...
  $("#biografia").on("click", function() {
    $("#checkout-biografia").slideToggle(900);
  });

  $("#galpon").on("click", function() {
    $("#checkout_galpon").slideToggle(900);
  });

  $("#equipo").on("click", function() {
    $("#checkout-equipo").slideToggle(1000);
  });

  $("#preguntas").on("click", function() {
    $("#checkout-preguntas").slideToggle(1000);
  });

  $("#suenio").on("click", function() {
    $("#checkout-suenio").slideToggle(1000);
  });
  /*--------------------------
     ScrollUp
    ---------------------------- */
