                ...
                <div class="row">
                    <div class="col-12 col-md-6 col-lg-4">
                        <div class="site-footer__widget footer-contacts">
                            ...
                            <ul class="footer-contacts__contacts">
                                ...
                                <li><i class="footer-contacts__icon far fa-envelope"></i> fseperak@profuturo.com.pe </li>
                    ...
                    <div class="col-6 col-md-3 col-lg-2">
                        <div class="site-footer__widget footer-links">
                            ...
                            <ul class="footer-links__list">
                                <li class="footer-links__item"><a href="http://localhost:81/navajasseperak/gallery.php" class="footer-links__link">Fotos</a></li>
                                <li class="footer-links__item"><a href="http://localhost:81/navajasseperak/gallery.php" class="footer-links__link">Videos</a></li>
                                <li class="footer-links__item"><a href="http://localhost:81/navajasseperak/gallery.php" class="footer-links__link">Artículos</a></li>
                            </ul>
                        </div>
                    </div>
                    <div class="col-12 col-md-12 col-lg-4">
                        <div class="site-footer__widget footer-newsletter">
                            <h5 class="footer-newsletter__title">Mis redes sociales</h5>
                            ...
                            <div class="social-links footer-newsletter__social-links social-links--shape--circle">
                                <ul class="social-links__list">
                                    ...
                                    <li class="social-links__item"><a class="social-links__link social-links__link--type--youtube" href="https://www.youtube.com/watch?v=xADgLYZCYR8&t=21s" target="_blank"><i class="fab fa-youtube"></i></a></li>
                                    <li class="social-links__item"><a class="social-links__link social-links__link--type--facebook" href="https://www.facebook.com/fseperak" target="_blank"><i class="fab fa-facebook-f"></i></a></li>
                                    <li class="social-links__item"><a class="social-links__link social-links__link--type--twitter" href="" ><i class="fab fa-twitter"></i></a></li>
                                    <li class="social-links__item"><a class="social-links__link social-links__link--type--instagram" href="" ><i class="fab fa-instagram"></i></a></li>
                                </ul>
