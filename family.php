        ...
        <div class="site__body">
            ...
            <div class="blog-area pt-120 pb-130">
                <div class="container" style="max-width: 1400px;">
                    <div class="row">
                        <div class="col-lg-6">
                            <div class="blog-details-wrapper res-mrg-top justifyText">
                                <h1>Mi motor y motivo</h1>
                                <p>
                                    Esta es m ifamilia OSWAN Lorem ipsum dolor sit amet, consectetur adipisicing elit,
                        ...
                        <div class="col-lg-6">
                            <div class="blog-details-wrapper res-mrg-top">
                                <div class="blog-img mb-30">
                                    <img src="images/familia/f1.jpg" class="satura" alt="image">
                                </div>
                            </div>
                        ...
                        <div class="col-lg-6">
                            <div class="blog-details-wrapper res-mrg-top">
                                <div class="blog-img mb-30">
                                    <img src="images/familia/f2.jpg" class="satura" alt="image">
                                </div>
                            </div>
                        </div>
                        <div class="col-lg-6">
