...
class EnviarCorreo
{
    ...
    function __construct($Destinatario, $SmtpHost, $SmtpUsuario,  $SmtpClave)
    {
 ...
 public  function prueba(){
    ...
    public function   enviarCorreo($nombre, $apellidos, $subject)
    {
        $nombre = $nombre;
        $subject = $subject;
        $destinatario = $this->Destinatario;
        $smtpHost = $this->SmtpHost;
        $smtpUsuario = $this->SmtpUsuario;
        $smtpClave = $this->SmtpClave;
        ...
        $mail->Body = "
                <html style='width:100%;font-family:lato, 'helvetica neue', helvetica, arial, sans-serif;-webkit-text-size-adjust:100%;-ms-text-size-adjust:100%;padding:0;Margin:0;'><head>
                ...
                <tr style='border-collapse:collapse;'> 
                    ...
                    <table class='es-header' cellspacing='0' cellpadding='0' align='center' style='mso-table-lspace:0pt;mso-table-rspace:0pt;border-collapse:collapse;border-spacing:0px;table-layout:fixed !important;width:100%;background-color:#1c3f4d;background-repeat:repeat;background-position:center top;'> 
                    <tbody>
                    <tr style='border-collapse:collapse;'> 
                        ...
                        <tr style='border-collapse:collapse;'> 
                            ...
                            <tr style='border-collapse:collapse;'> 
                                ...
                                <tr style='border-collapse:collapse;'> 
                                    ...
                                    <img src='http://navajasseperak.com/images/slides/slide-1-mobile.jpeg'>
                                    </td> 
                                </tr> 
                                </tbody>
                                </table></td> 
                    ...
                    <tbody>
                    <tr style='border-collapse:collapse;'> 
                        <td style='padding:0;Margin:0;background-color:#1c3f4d;' bgcolor='#1c3f4d' align='center'> 
                        ...
                        <tr style='border-collapse:collapse;'> 
                            ...
                            <tr style='border-collapse:collapse;'> 
                                ...
                                <tbody>
                                <tr style='border-collapse:collapse;'> 
                                    <td align='center' style='Margin:0;padding-bottom:5px;padding-left:30px;padding-right:30px;padding-top:35px;'><h1 style='Margin:0;line-height:58px;mso-line-height-rule:exactly;font-family:lato, 'helvetica neue', helvetica, arial, sans-serif;font-size:30px;font-style:normal;font-weight:normal;color:#111111;'>Unión de Galleros del Perú - UGP</h1></td> 
                                </tr> 
                                    <tr style='border-collapse:collapse;'> 
                                    <td align='center' style='Margin:0;padding-bottom:5px;padding-left:30px;padding-right:30px;padding-top:35px;'><h1 style='Margin:0;line-height:58px;mso-line-height-rule:exactly;font-family:lato, 'helvetica neue', helvetica, arial, sans-serif;font-size:30px;font-style:normal;font-weight:normal;color:#111111;'>FELICIDADES</h1></td> 
                                </tr> 
                                <tr style='border-collapse:collapse;'> 
                    ...
                    <tr style='border-collapse:collapse;'> 
                        ...
                        <tr style='border-collapse:collapse;'> 
                            ...
                            <tr style='border-collapse:collapse;'> 
                                ...
                                <tbody>
                                <tr style='border-collapse:collapse;'> 
                                    <td class='es-m-txt-l' bgcolor='#ffffff' align='left' style='Margin:0;padding-top:20px;padding-bottom:20px;padding-left:30px;padding-right:30px;'><p style='Margin:0;-webkit-text-size-adjust:none;-ms-text-size-adjust:none;mso-line-height-rule:exactly;font-size:18px;font-family:lato, 'helvetica neue', helvetica, arial, sans-serif;line-height:27px;color:#666666;'>Su solicitud enviada para formar parte de la Unión de Galleros del Perú - UGP fue aceptada con éxito</p></td> 
                                </tr> 
                                    <tr style='border-collapse:collapse;'> 
                                    <td class='es-m-txt-l' align='left' style='padding:0;Margin:0;padding-top:20px;padding-left:30px;padding-right:30px;'><p style='Margin:0;-webkit-text-size-adjust:none;-ms-text-size-adjust:none;mso-line-height-rule:exactly;font-size:18px;font-family:lato, 'helvetica neue', helvetica, arial, sans-serif;line-height:27px;color:#666666;'>
                                Comuníquese con el área de soporte para mayor información.
                                    </p>
                                    <p style='Margin:0;-webkit-text-size-adjust:none;-ms-text-size-adjust:none;mso-line-height-rule:exactly;font-size:18px;font-family:lato, 'helvetica neue', helvetica, arial, sans-serif;line-height:27px;color:#666666;'> Muchas gracias por su atención</p>
                                    </td> 
                                </tr> 
...
</body></html>"; // Texto del email en formato HTML
