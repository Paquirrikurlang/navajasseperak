                                            ...
                                            <div class="filter__container">
                                                <div class="filter-categories-alt">
                                                    <ul class="filter-categories-alt__list filter-categories-alt__list--level--1"
                                                        ...
                                                        <li class="filter-categories-alt__item" data-collapse-item=""><a
                                                        ...
                                                        <li class="filter-categories-alt__item" data-collapse-item="">
                                                            ...
                                                            <div class="filter-categories-alt__children"
                                                                ...
                                                                <ul
                                                                    ...
                                                                    <li class="filter-categories-alt__item"
                                                                        data-collapse-item=""><a href="">Drills</a></li>
                                                                    <li class="filter-categories-alt__item"
                                                                    ...
                                                                    <li class="filter-categories-alt__item"
                                                                        data-collapse-item=""><a href="">Wall Chaser</a>
                                                                    </li>
                                                                    <li class="filter-categories-alt__item"
                                                        ...
                                                        <li class="filter-categories-alt__item filter-categories-alt__item--open filter-categories-alt__item--current"
                                                            ...
                                                            <div class="filter-categories-alt__children"
                                                                ...
                                                                <ul
                                                                    ...
                                                                    <li class="filter-categories-alt__item"
                                                                        data-collapse-item=""><a href="">Knives</a></li>
                                                                    <li class="filter-categories-alt__item"
                                                                        data-collapse-item=""><a href="">Axes</a></li>
                                                                    <li class="filter-categories-alt__item"
                                                                        data-collapse-item=""><a href="">Multitools</a>
                                                                    </li>
                                                                    <li class="filter-categories-alt__item"
                                                                        data-collapse-item=""><a href="">Paint Tools</a>
                                                                    </li>
                                                                </ul>
                                                            </div>
                                                        </li>
                                                        ...
                                                        <li class="filter-categories-alt__item" data-collapse-item="">
                                                            ...
                                                            <div class="filter-categories-alt__children"
                                                                ...
                                                                <ul
                                                                    class="filter-categories-alt__list filter-categories-alt__list--level--2">
                                                                    <li class="filter-categories-alt__item"
                                                                        data-collapse-item=""><a href="">Motor Pumps</a>
                                                                    </li>
                                                                    <li class="filter-categories-alt__item"
                                        ...
                                        <div class="filter__body" data-collapse-content="">
                                            <div class="filter__container">
                                                <div class="filter-price" data-min="500" data-max="1500" data-from="590"
                                                    data-to="1130">
                                                    <div
                                                        class="filter-price__slider noUi-target noUi-ltr noUi-horizontal noUi-txt-dir-ltr">
                                                        <div class="noUi-base">
                                                            <div class="noUi-connects">
                                                                <div class="noUi-connect"
                                                                    style="transform: translate(9%, 0px) scale(0.54, 1);">
                                                                </div>
                                                            </div>
                                                            <div class="noUi-origin"
                                                                style="transform: translate(-910%, 0px); z-index: 5;">
                                                                <div class="noUi-handle noUi-handle-lower"
                                                                    data-handle="0" tabindex="0" role="slider"
                                                                    aria-orientation="horizontal" aria-valuemin="500.0"
                                                                    aria-valuemax="1130.0" aria-valuenow="590.0"
                                                                    aria-valuetext="590.00">
                                                                    <div class="noUi-touch-area"></div>
                                                                </div>
                                                            </div>
                                                            <div class="noUi-origin"
                                                                style="transform: translate(-370%, 0px); z-index: 4;">
                                                                <div class="noUi-handle noUi-handle-upper"
                                                                    data-handle="1" tabindex="0" role="slider"
                                                                    aria-orientation="horizontal" aria-valuemin="590.0"
                                                                    aria-valuemax="1500.0" aria-valuenow="1130.0"
                                                                    aria-valuetext="1130.00">
                                                                    <div class="noUi-touch-area"></div>
                                                                </div>
                                                            </div>
                                                        </div>
                                                    ...
                                                    <div class="filter-price__title">Price: $<span
                                                            class="filter-price__min-value">590.00</span> – $<span
                                                            class="filter-price__max-value">1130.00</span></div>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
